...
#pragma region BloodCell20Vertices
	...
	using BloodCellSprings =
        ...
        Spring<18, 17, 32102, 5>,
        Spring<2, 5, 71909, 5>,
        Spring<5, 8, 71909, 5>,
        Spring<8, 11, 71909, 5>,
        Spring<11, 14, 71909, 5>,
        Spring<14, 17, 71909, 5>,
        Spring<17, 2, 71909, 5>,
        Spring<2, 4, 40633, 5>,
        Spring<5, 7, 40633, 5>,
        Spring<8, 10, 40632, 5>,
        Spring<11, 13, 40633, 5>,
        Spring<14, 16, 40633, 5>,
        Spring<17, 19, 40632, 5>,
        Spring<4, 7, 43238, 5>,
        Spring<7, 10, 43238, 5>,
        Spring<10, 13, 43238, 5>,
        Spring<13, 16, 43238, 5>,
        ...
        Spring<5, 14, 143818, 5>,
        Spring<8, 17, 143818, 5>,
        Spring<3, 4, 41619, 5>,
        Spring<6, 7, 41619, 5>,
        Spring<9, 10, 41619, 5>,
        Spring<12, 13, 41619, 5>,
